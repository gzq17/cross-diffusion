...
class TrainLoop:
    ...
    def forward_backward(self, batch_data):
        batch = batch_data['data'].float()
        vessel_img = batch_data['vessel_img'].float()
        thick_label = batch_data['thick_label'].float()
        # vessel_img[:] = 0.0
        # thick_label[:] = 0.0
        # import pdb;pdb.set_trace()
        # fea_arr=[batch_data['fea_arr'].float(), batch_data['fea_arr2'].float(),
        #             batch_data['fea_arr3'].float(), batch_data['fea_arr4'].float()]
        ...
        for i in range(0, batch.shape[0], self.microbatch):
            ...
            # micro_fea_arr = [fea[i : i + self.microbatch].to(dist_util.dev()) for fea in fea_arr]
